      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="${pageContext.request.contextPath }/updatenovel/${sumcontext.id}" method="post">
              <div class="layui-row layui-col-space15 layui-form-item">
                  ...
                  <div class="layui-input-block">
                    <select lay-verify="required" name="special_column" lay-filter="column" style="z-index:999">
                      <fx:forEach items="${special_column }" var="special_column">
                     	<option value="${special_column.id }" ${sumcontext.special_column_id == special_column.id?'selected':' ' }>${special_column.special_column}</option>
                      </fx:forEach> 
                    </select>
                  </div>
                </div>
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" name="title" required lay-verify="required" autocomplete="off" class="layui-input" value="${sumcontext.title }">
              ...
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <!-- <textarea id="L_content" name="content" required lay-verify="required" placeholder="详细描述" class="layui-textarea fly-editor" style="height: 260px;"></textarea> -->
					<textarea id="editor" name="content" style="height: 260px;">
						${sumcontext.content}
					</textarea>  
                </div>
              </div>
                ...
                <div class="layui-inline">
                  ...
                  <div class="layui-input-inline" style="width: 190px;">
                    <select name=""><!-- experience -->
                      	<option value="${sumcontext.fly_kiss_id }" >${sumcontext.kiss.kiss_num }</option>
                    </select>
                  </div>
